...
fn main() -> anyhow::Result<()> {
    ...
    let go_schema: intermediate::GoSchema =
        serde_json::from_reader(std::fs::File::open(&opts.schema)?)?;

    // let go_schema = intermediate::GoSchema([
    //     ("data".to_string(), intermediate::Attribute{
    //         description: Some("Dummy".to_string()),
    //         optional: true,
    //         interpolation: intermediate::InterpolationStrategy::Nickel,
    //         type_: intermediate::Type::Object([
    //             ("test".to_string(), intermediate::Attribute{
    //                 description: Some("nested dummy".to_string()),
    //                 optional: true,
    //                 interpolation: intermediate::InterpolationStrategy::Nickel,
    //                 type_: intermediate::Type::Dynamic,
    //             })
    //         ].into()),
    //     })
    // ].into());
    ...
    println!("{go_schema:#?}");
    serde_json::to_writer_pretty(std::io::stdout(), &go_schema)?;
